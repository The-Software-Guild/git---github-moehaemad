...
public class ClassRosterDaoFileImpl implements ClassRosterDao{
    ...
    //<studentid>::<first name>::<last name>::<cohort> format of file
    private final static String DELIMITER = "::";
    private final static String ROSTER_FILE = "/Users/macomo/NetBeansProjects/mavenproject1/src/main/java/com/mycompany/mavenproject1/ClassesObjects/ClassRoster/classRoster.txt";
    @Override
